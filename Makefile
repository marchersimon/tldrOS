main:
	...
	gcc -fno-pic -m32 -ffreestanding -c kernel/kernel.c -o build/kernel.o
	ld -no-pie -m elf_i386 -o build/kernel.bin -Ttext 0x1000 build/kernel_entry.o build/kernel.o --oformat binary
